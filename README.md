...
---
Я Максим, увлекаюсь аналитикой и постоянно развиваю навыки в работе с данными. Создаю проекты, которые отражают мой интерес к аналитике и стремление применять знания на практике.
---
#### 📫 КОНТАКТЫ: 
...
|[Анализ эффективности интернет магазина в мобильном приложении](https://github.com/) | В работе | Расчет ключевых метрик по оценке эффективности работы мобильного приложения, поиск узких мест и рекомендации по улучшению.
